...
class TestSubmitWorkflow:
    ...
    async def test_submit_workflow_creates_entities(
        ...
        dag_data = {"nodes": [{"id": "start", "handler": "input", "dependencies": []}]}
...
class TestTriggerExecution:
    ...
    async def test_trigger_execution_publishes_root_tasks(
        ...
        dag_json = {"nodes": [{"id": "start", "handler": "input", "dependencies": []}]}
...
class TestGetWorkflowStatus:
    ...
    @pytest.mark.asyncio
    async def test_get_workflow_status_success(self, mock_execution_repo, mock_state_store):
...
class TestCancelWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_cancel_workflow_success(self, mock_execution_repo, mock_state_store):
